#This @rowindex variable will be used to order reply_time values and find the median.
...
SELECT 
	...
	#This subquery defines the logic needed to find "median_reply_time."
		...
		WHERE
		reply_med_prep.rowindex IN (FLOOR(@rowindex / 2) , CEIL(@rowindex / 2)) #This logic is finding the median using the rowindex.
